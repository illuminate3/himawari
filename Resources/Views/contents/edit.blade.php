...
<div class="tab-content padding">
	...
	<div role="tabpanel" class="tab-pane padding fade @if ($language->locale == $lang)in active @endif" id="lang_{{{ $language->id }}}">
			<div class="form-group">
				...
				<textarea class="form-control summernote" rows="3" name="{{ 'content_'. $language->id }}" id="{{ 'content_'. $language->id }}">{{{ $content->translate($language->locale)->content }}}</textarea>
			</div>
			...
			<div class="form-group">
				...
				<textarea class="form-control summernote" rows="3" name="{{ 'summary_'. $language->id }}" id="{{ 'summary_'. $language->id }}">{{ $content->translate($language->locale)->summary }}</textarea>
			</div>
